...
namespace RealmWars3D.Editor
{
    ...
    {
        static RealmWarsAssetSetup()
        {
            EditorApplication.delayCall += SyncSourceAssets;
        }
        ...
        public static void SyncSourceAssets()
        {
            ...
            string destinationRoot = Path.Combine(Application.dataPath, "Models");
            ...
            Debug.Log("Realm Wars: source GLB assets synchronized into Unity/Assets/Models.");
        }
        ...
        private static void CopyTree(string source, string destination)
        {
            ...
            foreach (string file in Directory.GetFiles(source, "*", SearchOption.TopDirectoryOnly))
            {
                ...
                if (extension != ".glb" && extension != ".gltf" && extension != ".bin" && extension != ".png" && extension != ".jpg" && extension != ".jpeg")
                    continue;
